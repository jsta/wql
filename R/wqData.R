wqData <-
    function(data, locus, wqdata, site.order, time.format = NULL, type = c("narrow", "wide"))
{
    ...
    levels(data$site) <- gsub('X','s', make.names(levels(data$site), unique = TRUE))
